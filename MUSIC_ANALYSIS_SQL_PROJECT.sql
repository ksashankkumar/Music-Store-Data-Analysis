...
3: What are the top 3 values of invoice

SELECT total FROM invoice
order by total desc
limit 3

4: Which city has the best customers?We would like to throw a promotional Music Festival in the city we made the most money.Write a query that returns one city that has the highest sum of invoice totals.Return both the city name and sum of all invoice toatal?
...
6: Lets invite the artists who have written the most rock music in our dataset.Write a query that returns the artist name and total track count of the top 10 rock bands
 ...
 7: Return all the track names that have a song lenght longer than the average song length.Return the Name and Milliseseconds for each track.Order by the song length with the longest songs listed first.
